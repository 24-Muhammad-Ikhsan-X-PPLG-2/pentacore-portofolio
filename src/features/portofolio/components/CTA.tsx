...
const CTA = () => {
  return (
    <section className="pb-16 px-4 sm:px-6 lg:px-8 bg-[#0b1326] flex justify-center text-white">
      <div className="w-full max-w-6xl bg-[#0052fe] rounded-2xl py-8 px-6 sm:px-10 flex flex-col lg:flex-row items-center gap-8">
