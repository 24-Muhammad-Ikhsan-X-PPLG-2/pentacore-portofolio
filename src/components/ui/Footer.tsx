        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 items-start lg:items-center">
          <div className="w-full lg:w-1/3">
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <a href="https://github.com/pentacorelabs" target="_blank">
                <svg
                  role="img"
                  width={24}
                  height={24}
          ...
          <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8">
            <div className="flex flex-col gap-4">
              ...
              <Link href={"/contact"}>
                <p className="hover:underline">Start Creating Project</p>
              </Link>
            </div>
            <div className="flex flex-col gap-4">
              <h2 className="text-[#c0c9fc] text-sm font-semibold">COMPANY</h2>
              <Link href={"/portofolio"}>
                <p className="hover:underline">Portofolio</p>
              </Link>
              <Link href={"/#recent-catalog"}>
                <p className="hover:underline">Available Services</p>
              </Link>
              <Link href={"/about"}>
